...
def similarity(smi1, smi2, partialCharges, methodPsi4, basisPsi4):
    ...
    if number_dummies_1 != number_dummies_2:
        ...
        simShape, frag1_with_anchor_aligned, frag2_with_anchor_aligned = EmbedAlignConstrainedScore(
            frag1_with_anchor_hs, frag2_with_anchor, core())
        ...
        sim_esp = round(
            GetEspSim(frag1_aligned_san, frag2_aligned_san, partialCharges=partialCharges, metric="tanimoto",
                      methodPsi4=methodPsi4, basisPsi4=basisPsi4, renormalize=True), 3)
