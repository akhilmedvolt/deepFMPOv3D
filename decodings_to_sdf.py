...
PandasTools.AddMoleculeColumnToFrame(
    df, smilesCol="smile", molCol="ROMol", includeFingerprints=False
)

PandasTools.WriteSDF(
    df, "sim.sdf", molColName="ROMol", idName=None, properties=None, allNumeric=False
)
...
PandasTools.AddMoleculeColumnToFrame(
    df_merge, smilesCol="smile", molCol="ROMol", includeFingerprints=False
)

PandasTools.WriteSDF(
    df_merge,
    "sim_ordered_decoding.sdf",
    molColName="ROMol",
    idName=None,
    properties=list(df_merge.columns),
    allNumeric=False,
)
